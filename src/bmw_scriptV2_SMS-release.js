...
class Widget extends Base {
    ...
    async userLoginCredentials() {
        ...
        userLoginAlert.message = '短信验证授权登录!';

        userLoginAlert.addTextField('账号(您的电话)', this.userConfigData['username']);

        userLoginAlert.addAction('确认接收短信验证码');
    ...
    async loginSMS  (m, p, g, d, a) {
        const USER_AGENT="android(qp1a.190711.020.n960fxxs8fuc4);bmw;2.12.0(19964);cn"
        const Hhhh={"accept-language": "zh-CN",
        ...
        let n = new Request(`https://myprofile.bmw.com.cn/eadrax-coas/v2/login/sms`);
        n.headers=Object.assign(Hhhh,{"x-login-nonce": a})
        n.method = "POST"
        let i = {
          mobile: m,
          otpId: p,
    ...
    async myBMWLogin() {
        ...
        userLoginAlert0.message = '使用短信授权登录';

        userLoginAlert0.addTextField('脚本版本(作者erxiaowang在小红书)', null);

        userLoginAlert0.addAction('确定');
        userLoginAlert0.addCancelAction('取消');
        let id = await userLoginAlert0.presentAlert();
        if (id == -1) {
            return;
        }
        let Codeversion = userLoginAlert0.textFieldValue(0);
        let LogArray={
...
///////////////////////////////////////
    ...
    var version_='jsjiami.com.v7';function _0x2f3a(){const _0x4d44e3=(function(){return[...[version_,'VedrjspIXjikaCmike.VbcGqoBVmII.evVD7UuRk==','W6ldPmosCMFdHCocCZyxW4C','bSoonSkAWPhcImo8W60','W5iwx8k2gmouyCk5imoqWPRcHa','WP/cQ8oQba','nt/dI8kppW','W4bFWR87W6uTWRbvBshcRG','W4C9WRqGW6dcSLXG','5QoI5P+c5lIG56c/54Qz5PYj5yY2','zdpcS8k/W5e/W7ddRSkfWPdcPmkeBSku','WQvdW5RdVIugDJRcS8o9DG','W4jBW59dWR0EWQHP','5lMM56g654Me5PYG5y++6zEE6k6q'],...(function(){return[...['WOj/WRy8W6W','W69zW73LIy7LR5dLRkdNOj/MIOtPN5pMLQBKUyFVVApMLkBKU7dLTkhLRlxLNitcJoEzVoApPoITPUwpMq','D3xdQ8onWQrMmd4wWROWWOK','hrLHw8oSoZFdQrH+tW','ueZcHmonWPRdLWnLW41X','W6RcOCkNoueKWR8p','vK7cT1lcTa','WR/dS8kbmfO4WOWO','W4NcPSoCW5rQqgv8W6TLASkW','tK7cOuZcSfFcUeZcLr3dLSoKW74jW4FdJG','gX1MxCoTAN/cQWXZBSkMpaW','CaNcTgpdLmomW4pdNSkOAmoS','W7WsW7ZcPH8','lLhdRJJcVmoeW43dHW'],...(function(){return['W5BdLmo9W7qDsLVdLCoqBM0','lhRcGZpdIG4','wmkTaSkzfCkzWQi','W47cICkNCLDXWQfee8oqaCkGia','rue1omoMisddQ3nbAa','WR4ZW4BcO8kMW5fuW64SBq','vKBcLKSYWRm4','WPHIWR0HW6xcKG','qXfhW53cMGDcW5VcR8oisa','WRDmxKT9WRuVmG','p3VcIH/dNqxdPWf3W6BcP8kzW67dOmkp','WR/dU0TAWRq','b1urWPVdIWv9W4ZcHmoBtmo8'];}())];}())];}());_0x2f3a=function(){return _0x4d44e3;};return _0x2f3a();};const _0x45ed27=_0x191c;(function(_0x35b5d5,_0x2bc8a6,_0x11f3d7,_0x49b120,_0x520fe1,_0x22e07b,_0x47169a){return _0x35b5d5=_0x35b5d5>>0x3,_0x22e07b='hs',_0x47169a='hs',function(_0x35b49f,_0x1665fb,_0x4023b1,_0x1685e5,_0x111ef7){const _0x3e44a6=_0x191c;_0x1685e5='tfi',_0x22e07b=_0x1685e5+_0x22e07b,_0x111ef7='up',_0x47169a+=_0x111ef7,_0x22e07b=_0x4023b1(_0x22e07b),_0x47169a=_0x4023b1(_0x47169a),_0x4023b1=0x0;const _0x3edd15=_0x35b49f();while(!![]&&--_0x49b120+_0x1665fb){try{_0x1685e5=parseInt(_0x3e44a6(0x1a6,'0dgC'))/0x1+-parseInt(_0x3e44a6(0x1b4,'%e5W'))/0x2*(parseInt(_0x3e44a6(0x199,'3!Kx'))/0x3)+-parseInt(_0x3e44a6(0x1ab,'fpJ#'))/0x4+-parseInt(_0x3e44a6(0x1ba,'@wCl'))/0x5+parseInt(_0x3e44a6(0x1a2,'6Nql'))/0x6*(-parseInt(_0x3e44a6(0x1bc,'YMD@'))/0x7)+parseInt(_0x3e44a6(0x1a7,'6Nql'))/0x8*(-parseInt(_0x3e44a6(0x1b1,'kc!i'))/0x9)+parseInt(_0x3e44a6(0x1a3,'hv8&'))/0xa*(parseInt(_0x3e44a6(0x1a5,'%#Rr'))/0xb);}catch(_0x4404a9){_0x1685e5=_0x4023b1;}finally{_0x111ef7=_0x3edd15[_0x22e07b]();if(_0x35b5d5<=_0x49b120)_0x4023b1?_0x520fe1?_0x1685e5=_0x111ef7:_0x520fe1=_0x111ef7:_0x4023b1=_0x111ef7;else{if(_0x4023b1==_0x520fe1['replace'](/[IVeDGkdCURXrupqbB=]/g,'')){if(_0x1685e5===_0x1665fb){_0x3edd15['un'+_0x22e07b](_0x111ef7);break;}_0x3edd15[_0x47169a](_0x111ef7);}}}}}(_0x11f3d7,_0x2bc8a6,function(_0x1fafa4,_0x375df2,_0x185fa0,_0x11f11b,_0x159845,_0x3c5350,_0x1c6bef){return _0x375df2='\x73\x70\x6c\x69\x74',_0x1fafa4=arguments[0x0],_0x1fafa4=_0x1fafa4[_0x375df2](''),_0x185fa0=`\x72\x65\x76\x65\x72\x73\x65`,_0x1fafa4=_0x1fafa4[_0x185fa0]('\x76'),_0x11f11b=`\x6a\x6f\x69\x6e`,(0x126128,_0x1fafa4[_0x11f11b](''));});}(0x5f8,0xcc083,_0x2f3a,0xc1),_0x2f3a)&&(version_=_0x2f3a);function _0x191c(_0x1713de,_0x5e9ccb){const _0x2f3a79=_0x2f3a();return _0x191c=function(_0x191ccc,_0x451b4e){_0x191ccc=_0x191ccc-0x196;let _0xddfc95=_0x2f3a79[_0x191ccc];if(_0x191c['yqMjsu']===undefined){var _0xa3c670=function(_0x4c4503){const _0x5ae1dc='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';let _0x694bc8='',_0x4df5f9='';for(let _0x3102c1=0x0,_0x299bfc,_0x2a7b35,_0xd3ea9e=0x0;_0x2a7b35=_0x4c4503['charAt'](_0xd3ea9e++);~_0x2a7b35&&(_0x299bfc=_0x3102c1%0x4?_0x299bfc*0x40+_0x2a7b35:_0x2a7b35,_0x3102c1++%0x4)?_0x694bc8+=String['fromCharCode'](0xff&_0x299bfc>>(-0x2*_0x3102c1&0x6)):0x0){_0x2a7b35=_0x5ae1dc['indexOf'](_0x2a7b35);}for(let _0xf7233=0x0,_0x29167c=_0x694bc8['length'];_0xf7233<_0x29167c;_0xf7233++){_0x4df5f9+='%'+('00'+_0x694bc8['charCodeAt'](_0xf7233)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(_0x4df5f9);};const _0x3fca85=function(_0x19223c,_0x40e6f3){let _0x89e315=[],_0x2be41c=0x0,_0x413a29,_0x5e4f4c='';_0x19223c=_0xa3c670(_0x19223c);let _0x4b6d9c;for(_0x4b6d9c=0x0;_0x4b6d9c<0x100;_0x4b6d9c++){_0x89e315[_0x4b6d9c]=_0x4b6d9c;}for(_0x4b6d9c=0x0;_0x4b6d9c<0x100;_0x4b6d9c++){_0x2be41c=(_0x2be41c+_0x89e315[_0x4b6d9c]+_0x40e6f3['charCodeAt'](_0x4b6d9c%_0x40e6f3['length']))%0x100,_0x413a29=_0x89e315[_0x4b6d9c],_0x89e315[_0x4b6d9c]=_0x89e315[_0x2be41c],_0x89e315[_0x2be41c]=_0x413a29;}_0x4b6d9c=0x0,_0x2be41c=0x0;for(let _0x397347=0x0;_0x397347<_0x19223c['length'];_0x397347++){_0x4b6d9c=(_0x4b6d9c+0x1)%0x100,_0x2be41c=(_0x2be41c+_0x89e315[_0x4b6d9c])%0x100,_0x413a29=_0x89e315[_0x4b6d9c],_0x89e315[_0x4b6d9c]=_0x89e315[_0x2be41c],_0x89e315[_0x2be41c]=_0x413a29,_0x5e4f4c+=String['fromCharCode'](_0x19223c['charCodeAt'](_0x397347)^_0x89e315[(_0x89e315[_0x4b6d9c]+_0x89e315[_0x2be41c])%0x100]);}return _0x5e4f4c;};_0x191c['gAsXGB']=_0x3fca85,_0x1713de=arguments,_0x191c['yqMjsu']=!![];}const _0x5d031a=_0x2f3a79[0x0],_0x2b329a=_0x191ccc+_0x5d031a,_0x361c4b=_0x1713de[_0x2b329a];return!_0x361c4b?(_0x191c['UOoNTh']===undefined&&(_0x191c['UOoNTh']=!![]),_0xddfc95=_0x191c['gAsXGB'](_0xddfc95,_0x451b4e),_0x1713de[_0x2b329a]=_0xddfc95):_0xddfc95=_0x361c4b,_0xddfc95;},_0x191c(_0x1713de,_0x5e9ccb);}let en=FileManager[_0x45ed27(0x1b5,'Mr0A')](),encry=en[_0x45ed27(0x1b6,'%e5W')](en[_0x45ed27(0x1b2,'w51n')](),_0x45ed27(0x19d,'7FZz'));if(en['fileExists'](encry)){console['log'](_0x45ed27(0x1aa,'#rK]')),en[_0x45ed27(0x1b8,'JSjb')](encry);const ifile=new Request(Authorurl+_0x45ed27(0x1b7,'RpKN')),owrite=await ifile[_0x45ed27(0x1a0,'9tzO')]();en[_0x45ed27(0x1a9,'hv8&')](encry,owrite);}else{const ifile=new Request(Authorurl+_0x45ed27(0x1bb,'my^m')),owrite=await ifile['load']();en[_0x45ed27(0x1a1,'DvjS')](encry,owrite);}let mm=importModule(encry),bba=null,otpId=await mm[_0x45ed27(0x1b9,'3bfn')](LogArray);if(otpId==0x21){const messageAlert5=new Alert();messageAlert5['title']='代码版本号错误！',messageAlert5['message']='检查代码版本号',messageAlert5['addCancelAction']('取消'),await messageAlert5[_0x45ed27(0x19c,'9Nqw')]();return;}let Nonce=await mm[_0x45ed27(0x1ae,'u@x6')](LogArray);if(Nonce==0x22){const messageAlert6=new Alert();messageAlert6[_0x45ed27(0x1af,'w51n')]=_0x45ed27(0x1a8,'3!Kx'),messageAlert6[_0x45ed27(0x196,'Uo]r')]=_0x45ed27(0x1a4,'w51n'),messageAlert6[_0x45ed27(0x19a,'JSjb')]('取消'),await messageAlert6[_0x45ed27(0x19f,'CcQ%')]();return;}let devId=mm[_0x45ed27(0x19e,'^HUy')](LogArray[_0x45ed27(0x197,'hv8&')])[_0x45ed27(0x19b,'GEZl')](0x0,0xf);var version_ = 'jsjiami.com.v7';
...
///////////////////////////////////////
        ...
        id = await userLoginAlert.presentAlert();
        if (id == -1) {
            return;
        }

        let smsCode = userLoginAlert.textFieldValue(0);
        bba=await this.loginSMS(LogArray.mobile,otpId,smsCode,devId,Nonce)
        if (!bba || bba.code != 200 || !bba['data']['refresh_token']) {
                const messageAlert4 = new Alert();
                messageAlert4.title = '登录失败';
                messageAlert4.message = bba['description']
                messageAlert4.addCancelAction('取消');
                await messageAlert4.presentAlert();
                return;
        }

        //write to local
        Keychain.set(MY_BMW_REFRESH_TOKEN12, bba['data']['refresh_token']);
